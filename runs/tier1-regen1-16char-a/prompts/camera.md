Design a tiny voxel icon of: "camera"
...
silhouette of a camera — the shape someone would draw as a flat icon.
...
feature: <the ONE silhouette feature that says "camera", and how you are
