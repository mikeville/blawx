...
Each row is run-length encoded: count+symbol pairs that sum to exactly 16.
"1.2#1." means 1 empty, 2 filled, 1 empty. "16." is an all-empty row.
One row per line, top to bottom. Each mask has exactly 16 lines.
